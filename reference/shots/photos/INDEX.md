...
- bn-lapd-bloom-tile.png — (BN, 2026-09-23) the LAPD optics bottom-middle tile alone: warm veiling bloom from the lamp side, sharp texture under it, black far corner ("the one alone, it should kinda be like that")
- lapd-ref-solar-lava-ultramarine-pigment.jpg — (LAPD LOOK, 2026-09-24) two jars of thick pigment: fluorescent "solar lava" orange-red and ultramarine blue, plus a spoonful of the orange; the user: "maybe try something like this, I was kinda imagining this" = the DENSITY (opaque, dye-filled, faintly granular) and the pair (hot orange-red main, deep ultramarine accent on a neutral/dark ground)
- blacklight-ref-1-blue-film-black-oil-panel.jpg — (BS, 2026-09-24) the user's own panel, an older look: bold saturated blue film, pitch-black oil masses and droplets, backlit feel
- blacklight-ref-2-pink-film-black-mass-panel.jpg — (BS, 2026-09-24) the user's own panel: hot pink film, one huge black mass with a few pink glints inside it
- blacklight-ref-3-murky-water-divers.jpg — (BS, 2026-09-24) divers in green murky water, a hot light source above scattering through the murk, silhouettes pitch black; the user: "like that, but with glowing oil" = the medium carries the light, the oil is a silhouette except the few glowing masses
- blacklight-ref-4-glowstick-jars.jpg — (BS, 2026-09-24) glow-stick liquid in jars under UV: magenta, pink, blue; the liquid is self-luminous with a brighter core, glowing particles inside, soft bleed into the dark surround; the user: "maybe like this?" for how the glowing bodies should look
- bt-panel-1..5 (BT, 2026-09-24, the user's own panel, older looks): 1 magenta film, black masses, soft yellow-green hue2 patches; 2 same with a big green patch and small glowing green specks in the black; 3 magenta with yellow-green patches; 4 teal glowing droplets inside a black mass on magenta; 5 blue/magenta film, red glowing droplets inside the black mass, one blue glow. The user: "the soft opposite colour shading works very well but needs a physical analogue... light + fluorescent particles can add those elements while still having the same composition as these photos"
- bt-panel-6-pale-yellow-soft-black-masses.jpg / bt-panel-7-cyan-soft-masses-green-patch.jpg — (BT, 2026-09-24) the user's panel, "more photos that show murkiness": pale yellow / cyan film, big black masses with SOFT penumbra edges that feel submerged, slight translucency at the thin edges, a faint green patch on the cyan; the murk is the soft-edge depth, not a haze
- liquid-acid-ref-8-magenta-blue-cyan-yellow-discs.jpg — (2026-09-24) Liquid Acid stock footage: magenta / blue / cyan / yellow-green fully saturated dyed masses with blue discs; the user: "the only real reason for the ability to dye the black is for things like this... still looks cool, but can be put aside for now" = the fully-dyed multicolour look is SHELVED; black oil + glow is the direction
- lapd-look-user-0924-panel.jpg — (LAPD LOOK, 2026-09-24 17:15) the OLED photographed IRL after the user tuned the r8 look live: dark green-black film, blue droplets with cyan rims in sharp focus, red mass right, faint streaks and hairs; user: "I increased focus on the main dots, less artifacting. Ignore the composition entirely. Save those settings/look" = reference/configs/lapd-look-user-0924.ini
- bu-lr-1,3,4 (BU, 2026-09-24 evening, the user's Lightroom edits of hq-mono-0924): 1 split toning, shadows hue 171 sat 100 = the black oil goes deep teal on the pink film ("silver"); 3 graduated filter left->right: temp -54, saturation -50, dehaze +100, blacks -20 = pink-purple to desaturated blue-grey with a mottled dehazed film; 4 graduated filter saturation -100 on the right half = saturated pink fading to grey across the frame. User: "cycling through effects, as we already cycled through hues... I thought the light would do a similar gradient effect; line it up with it; idk what effect yet"
- proven-1-magenta-black.jpg .. proven-4-blue-red-panel.jpg (2026-09-25, user): the PROVEN oil looks = one colour (magenta film + black oil) or two colours primary+secondary (magenta/green, magenta/cyan, blue/red-orange). User: "3 colors adding or 4 is weird but a fine mix up". Ground truth for the cycle weights (7 proven : 2 moderate : 1 wild). Copies in handoff\review\proven\.
