...
| `[liquid_acid] film_hue2_lift` |   second hue yellow lift | 0..1, step 0.05 | 0.0 |  | Per pixel, the hue2 PATCH share only, and only in the gold..lime band (~35..95 deg): V up toward 1 (never down) and S up a little, so a yellow patch never goes olive. 0 = off. Brief BV |
| `[liquid_acid] film_hue3_lift` |   third hue yellow lift | 0..1, step 0.05 | 0.0 |  | The same lift for the hue3 patch share. 0 = off. Brief BV |
