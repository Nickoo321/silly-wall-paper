...
- bu-lr-1..4 (BU, 2026-09-24 evening, the user's Lightroom edits of hq-mono-0924): 1 split toning, shadows hue 171 sat 100 = the black oil goes deep teal on the pink film ("silver"); 2 crop showing the film grain texture; 3 graduated filter left->right: temp -54, saturation -50, dehaze +100, blacks -20 = pink-purple to desaturated blue-grey with a mottled dehazed film; 4 graduated filter saturation -100 on the right half = saturated pink fading to grey across the frame. User: "cycling through effects, as we already cycled through hues... I thought the light would do a similar gradient effect; line it up with it; idk what effect yet"
