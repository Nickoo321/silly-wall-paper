...
**419 keys total** (ini-backed; excludes the registry-only "Start with Windows" row), **347 with sliders**, **72 read-only** (no control in the settings window, main.cpp-only), **10 inert or unverified** in the current live preset.
