...
static void BuildDefs() {
    ...
    s_sliders = {
        ...
        { L"Spot refraction doubles (fraction)",0,     1,    0.02f, 2, &c.acid.spotDoubleFrac, nullptr, L"liquid_acid", L"spot_double_frac", false, nullptr, 3, L"Share of spots (droplets and blobs) that carry a faint displaced second image of their surroundings" },
        { L"Spot double offset (px)",           0,    12,    0.5f,  1, &c.acid.spotDoubleOffset, nullptr, L"liquid_acid", L"spot_double_offset", false, nullptr, 3, L"How far the second image is displaced, radially away from the spot centre" },
        { L"Spot double strength",              0,     1,    0.02f, 2, &c.acid.spotDoubleStrength, nullptr, L"liquid_acid", L"spot_double_strength", false, nullptr, 3, L"How strongly the doubled image is blended in" },
        { L"Spot double reach (x radius)",      0.2f,  4,    0.1f,  1, &c.acid.spotDoubleRadius, nullptr, L"liquid_acid", L"spot_double_radius", false, nullptr, 3, L"How far out from the spot the double fades away" },
        ...
        { L"Aberration max (px)",               0,     8,   0.25f, 2, &c.post.aberrationMaxPx,nullptr, L"post", L"aberration_max_px", false, nullptr, 3, L"The split at the corners, in pixels, at amount 1" },
    };
    s_checks = {
